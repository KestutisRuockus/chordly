...
const SchedulePicker = ({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-6 relative">
      ...
      <div className="grid grid-cols-7 overflow-x-scroll gap-1 mt-4">
        {weekDays.map((day) => {
          const isEnabled =
            selectionMode === "multi" ||
      ...
      >
        ...
        <div className="flex gap-2">
          <button
            type="submit"
            className="rounded border px-4 py-2 bg-primary text-primary-foreground rouned-md hover:bg-primary/70 transition-colors duration-300"
